/**
 * @file InfiniteGallery 组件
 * @description 3D无限滚动画廊组件，使用React Three Fiber实现沉浸式图片展示效果
 * @author YYC³
 * @version 1.0.0
 * @created 2025-09-15
 */
		...
		<>
			{planesData.current.map((plane, i) => {
				...
				if (texture.image) {
					...
					if (img.width && img.height && typeof img.width === 'number' && typeof img.height === 'number') {
